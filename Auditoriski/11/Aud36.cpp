...
private:
    T real, imag;
public:
    MyComplex<T>(T rel = 0, T imag = 0) : real(rel), imag(imag) {}
    ...
    friend MyComplex<T> operator+(T value, const MyComplex<T> &rhs) {
        return rhs + value;
    }
