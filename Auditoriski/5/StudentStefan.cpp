//Да се напише класа за опис ученици. За секој ученик се чува името (динамички алоцирана низа од знаци), низа од оценки,
// големина на низата и школска година (цел број). За оваа класа да се имплементираат:
//
...
//
//Потоа треба да се креира класа за опишување на паралелка што содржи динамички алоцирана низа од ученици, како и број
// на елементи во низата. За оваа класа да се имплементираат:
//
//Конструктори и деструктор
//
