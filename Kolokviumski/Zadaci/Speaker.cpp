...
//
//Максималното дозволено траење е исто за сите конференции и е одредено од организаторот на конференциите, а иницијално
// изнесува 360 минути (6 часа -  се смета како збир на сите предавања на конференцијата).
//
...
//
//Оператор += за додавање на нов предавач на конференцијата (5 поени). Предавач може да се додаде само ако вкупното
// времетраење на сите предавања од конференцијата не го надминува максималното траење на конференцијата. Доколку се
// обидеме да додадеме предавач со предавање кое ќе го надмине овој лимит, да се фрли исклучок од типот InvalidOperation
// со порака "Conference duration exceeded" и да се овозможи механизам за справување со овој исклучок во main. (10 поени)
//
...
int Conference::MAX_DURATION = 360;
